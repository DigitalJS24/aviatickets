...
import favoritesIdent from './favoritesIdent';
...
class Locations {
    ...
    async init() {
        ...
        this.shortCitiesList = this.createShortCitieList(this.cities);
    ...
    serializeTickets(tickets) {
        return Object.values(tickets).map(ticket => {
            return {
                ...
                favorites_ident: favoritesIdent.getFavoritesIdent(ticket),
            }
        })
    }
